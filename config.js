...
module.exports = {
	...
	//默认TDK
	TDK: {
    title: '时光流影TIMEFACE – 全球首个文化生活类社交平台',
    description: '时光流影TIMEFACE是时代出版倾力打造的集图片分享、文章阅读、话题讨论、活动交流为一体的文化生活类社交平台，用户可以在平台分享自己的时光并制作成POD时光书，更能在线申请打印出版。每个人的时光，都是一本流影的书。',
    keywords: '时光流影, POD'
	},
